...
export type StorageHash =
  StorageHashBase<'22545ce06839d4a23b53834c888438ea13711633c16325030718b5cd318b947d'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Message: {
      ...
      readonly senderUserId: CodecTypes['pg/int4@1']['output'];
      readonly recipientUserId: CodecTypes['pg/int4@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly Message: {
      ...
      readonly senderUserId: CodecTypes['pg/int4@1']['input'];
      readonly recipientUserId: CodecTypes['pg/int4@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            readonly message: {
              ...
              indexes: readonly [
                {
                  readonly name: 'message_senderUserId_idx_64078a57';
                  readonly prefix: 'message_senderUserId_idx';
                  readonly columns: readonly ['senderUserId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'message_recipientUserId_idx_fd367dfa';
                  readonly prefix: 'message_recipientUserId_idx';
